...
#dt_plana<-dt_plana%>%mutate(IMC.valor_cat=case_when(TT103valor   <15~ "IMC.valor   <15",
#                                                    TT103valor   >=15 & TT103valor   <25 ~ "IMC.valor   >=15 & IMC.valor",  
#                                                    TT103valor   >=25 & TT103valor   <30 ~ "IMC.valor   >=25 & IMC.valor   <30",
#                                                    TT103valor   >=30  ~ "IMC.valor   >=30"))
